...
export default function Projects(props) {
  return (
    <>
      <div style={{ paddingBottom: '80px' }}         id="Projects" ></div>

      <div

        className={`${classes.projects} ${props.mode == "light" ? classes.light : classes.dark
          }`}
      >
        <h1>Projects</h1>
        <div className={classes.selectection__container}>
          <div
            className={`single project-multi-selector ${props.mode == "light" ? "light" : "dark"
              }`}
          >
            <Multiselect
          ...
          <div
            className={`project-multi-selector multiple ${props.mode == "light" ? "light" : "dark"
              }`}
          >
            <Multiselect
